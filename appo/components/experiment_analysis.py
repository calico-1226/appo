"""This module contains functions to analyze experiment results."""
...
from appo.components.mpi_tools import proc_id, num_procs, gather_and_stack
...
class EnvironmentEvaluator(object):
    ...
    def eval(self, env, ac, num_evaluations):
        ...
        returns = list(gather_and_stack(returns))
        costs = list(gather_and_stack(costs))
