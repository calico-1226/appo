...
from appo.components.core import combined_shape, discount_cumsum
from appo.components.vtrace import calculate_v_trace
from appo.components.mpi_tools import mpi_statistics_scalar
...
class Buffer:
    ...
    def get(self):
        ...
        if self.standardize_advantages:
            ...
            cadv_mean, cadv_std = mpi_statistics_scalar(self.cost_adv_buf)
